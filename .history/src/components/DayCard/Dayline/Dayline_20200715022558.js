    ...
    return (
        <>
            <div className="row">
                ...
                {transports.map(tr =>{
                    return <div className='col-12 trasport-circle '><FontAwesomeIcon  className={utils.arrayAssociativo[tr.typology].classe}  icon={utils.arrayAssociativo[tr.typology].icon} /></div>
                })}
