			...
			<>
				<MyContext.Provider value={datiJson}>
					...
					<div className="container">
						<MyContext.Provider value={{ nomiCitta: arrayCitta.map(citta => {nome: citta.nome, posizione: citta.coordinate}), dateFrom: datiJson.dateFrom, dateTo: datiJson.dateTo, partecipanti: datiJson.partecipants }}>
							<div id="id1">
								<MyTravel></MyTravel>
							</div>
						</MyContext.Provider>
