...
export default function Referente(){
    ...
    return(
        <>
        <div className="container container-scheda">
        <div className='col-10 offset-1'>
        <div className="row">
        
        <div className="col-5 separatore-scheda">
        ...
        <p className="little">Il tuo referente è <p className="h6 orange-color">{contesto.operator.name}</p></p>
        <br></br><br></br>
