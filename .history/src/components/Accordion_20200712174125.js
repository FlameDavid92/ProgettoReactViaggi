            ...
            {<div className="accordion m-4">
                <div className="title-accordion row">
                    <div className="d-flex align-items-center justify-content-between col-12 col-md-10 offset-md-1">
                        <p className="title m-0">{contesto.nome} <span className="date-text">{getDateDalAlNoYear(contesto.giorni[0].data, contesto.giorni[contesto.giorni.length-1].data)}</span></p>
