...
export default function NavBar({ navlinks, currentHover }) {
    ...
    return (
        <nav className="navbar container-fluid sticky-top navbar-expand navbar-light my-nav">
                ...
                <div className="collapse navbar-collapse">
                    ...
                    <button onClick={logout} className="btn btn-sm btn-outline-danger my-2 logout">Logout</button>
                </div>
