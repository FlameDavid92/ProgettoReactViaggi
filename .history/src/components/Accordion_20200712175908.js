        ...
        <>
            {<div className="accordion m-4">
                <div className="title-accordion row">
                    ...
                    <p className="title m-0">{contesto.nome} {date && <span className="date-text">{utils.getDateDalAlNoYear(contesto.giorni[0].data, contesto.giorni[contesto.giorni.length-1].data)}</span>}</p>
