            ...
            <div className="container mt-3">
                <div className="row">
                    <div className="col">
                        ...
                        <p><span className="mycolor-orange">&#129106;</span> {utils.getDateDalAl(contesto.dateFrom, contesto.dateTo)}</p>
                        <p><span className="mycolor-orange">&#129106;</span> {`${numeroAdulti} adult${(numeroAdulti > 1) ? "i" : "o"}`} {(numeroBambini !== 0) && (`${numeroBambini} bambin${(numeroBambini > 1) ? "i" : "o"}`)}</p>
                    </div>
                </div>
            </div>
        </div>
