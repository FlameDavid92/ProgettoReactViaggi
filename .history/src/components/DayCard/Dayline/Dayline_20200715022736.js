    ...
    return (
        <>
            <div className="row">
                ...
                {transports.map(tr =>{
                    return <div className='col-12 transports-circle'><FontAwesomeIcon  className={arrayAssociativo[tr.typology].classe}  icon={arrayAssociativo[tr.typology].icon} /></div>
                })}
