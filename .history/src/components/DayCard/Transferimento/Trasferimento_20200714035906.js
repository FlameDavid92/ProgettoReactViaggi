    ...
    return( 
        ...
        { contesto.map((transfer,i)=>{
            return(
                ...
                <p>{transfer.description}..<Link onClick={()=>utils.funzioneApriModale(setModTrasferimento,modTrasferimento)}>Scopri di più</Link></p>
                <Modale click = {modTrasferimento}></Modale>
