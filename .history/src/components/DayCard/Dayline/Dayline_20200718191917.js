        ...
        <>
            <div className="row h-100">
                <div className='col-12 text-center'>
                    <div className="day-circle text-white">Day {giorno}</div>
                </div>
                {Array(attivita).fill(null).map(att => {
                    return <div className='col-12'>
                        <div className="activity-circle text-center"><FontAwesomeIcon icon={faMapMarker} /></div></div>
                })}
                {transports.map(tr => {
                    return <div className='col-12'>
                        <div className="div-transport text-center">
