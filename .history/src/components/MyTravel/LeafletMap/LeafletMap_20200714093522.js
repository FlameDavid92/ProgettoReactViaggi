...
export default function LeafletMap() {
  ...
  contesto.citta.forEach(citta => {
    centerLatitudine += citta.posizione.latitudine;
    centerLongitudine += citta.posizione.longitudine;
  });
  centerLatitudine = (latitudine/contesto.citta.length);
  centerLongitudine = (longitudine/contesto.citta.length);
