            ...
            <div className="col-10">
                <div className="row">
                    ...
                    <div className="col-12">
                       ...
                       <Modale click = {modAttivita}></Modale>
                       <button onClick={()=>utils.funzioneApriModale(setModAttivita,modAttivita)} className='btn-outline-primary'>Click modale</button> 
                    </div>
                </div>
