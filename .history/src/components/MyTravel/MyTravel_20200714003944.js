    ...
    return (
        <div className="border-radius-10 shadow bg-white m-4">
            ...
            <div className="container-fluid mt-3">
                <div className="row">
                    <div className="col">
                        <p className="mediumTitle color-orange mb-0">IL MIO VIAGGIO IN SICILIA</p>
                        <p className="tinyText">{contesto.citta.map((citta, i) => {return <> {citta.nome} <span className="color-grey">{">"}</span></>})} {contesto.citta[0].nome}</p>
